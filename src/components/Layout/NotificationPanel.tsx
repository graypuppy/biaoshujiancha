...
export const NotificationPanel: React.FC<NotificationPanelProps> = ({
  ...
  // formatTime is imported from utils
            ...
            notifications.map((notification) => (
              ...
              >
                <div className="flex gap-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${notification.type === NotificationType.SYSTEM ? 'bg-blue-50 text-brand' :
